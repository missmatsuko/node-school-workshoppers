...
// To use your new module in your original program file, use the require() call in the same way that you require('fs') to load the fs module. The only difference is that for local modules must be prefixed with './'. The '.js' is optional here and you will often see it omitted.
const filteredLs = require('./06_make-it-modular_module');
...
filteredLs(dirName, fileExt, callback)
